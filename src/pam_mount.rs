...
fn on_login(pamh: pam_handle_t) -> PamResult {
    match pam::get_password(pamh) {
        ...
        Err(err) => {
            syslog::err(&format!("pam_sm_authenticate: unable to get credentials: {}", err))
        }
    }
    PAM_SUCCESS
}
...
pub extern "C" fn pam_sm_open_session(pamh: pam_handle_t,
                                      flags: c_int,
                                      argc: size_t,
                                      argv: *const u8)
                                      -> c_int {
...
#[no_mangle]
#[allow(unused_variables)]
pub extern "C" fn pam_sm_close_session(pamh: pam_handle_t,
                                       flags: c_int,
                                       argc: size_t,
                                       argv: *const u8)
                                       -> c_int {
...
#[no_mangle]
#[allow(unused_variables)]
pub extern "C" fn pam_sm_authenticate(pamh: pam_handle_t,
                                      flags: c_int,
                                      argc: size_t,
                                      argv: *const u8)
                                      -> c_int {
...
#[no_mangle]
#[allow(unused_variables)]
pub extern "C" fn pam_sm_setcred(pamh: pam_handle_t,
                                 flags: c_int,
                                 argc: size_t,
                                 argv: *const u8)
                                 -> c_int {
